                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <jc:forEach items="${assessmentBean.trainerAvgAssessmentsByTraining(activeUser)}" var="assessment">
                                        <tr>

                                            <td>${assessment.enrollment.training.title}</td>
                                            <td>${assessment.enrollment.training.duration}</td>
                                            <td>${assessment.enrollment.training.description.length() < 40 ?
                                            assessment.enrollment.training.description : assessment.enrollment.training.description.substring(0, 30).concat("...")}</td>
